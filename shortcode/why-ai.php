...
function why_ai($atts,$content){
	...
	$why_ai = shortcode_atts(array(
		...
		'overview_link' => '<ul><li><a href="#" data-scroll-nav="4"><i class="fa fa-arrow-right" aria-hidden="true"></i>Why AI?</a></li>
									...
									<li><a href="#" data-scroll-nav="10"><i class="fa fa-arrow-right" aria-hidden="true"></i>How does NLP relate to AI?</a></li>
									<li><a href="#" data-scroll-nav="12"><i class="fa fa-arrow-right" aria-hidden="true"></i>Real world examples.</a></li></ul>',
